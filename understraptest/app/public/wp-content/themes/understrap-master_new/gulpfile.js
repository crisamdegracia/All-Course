...
/* Because gulp can't process ES6 module, or  I say I cant make it to work
this code is calling our webpack config for .js files to compile
I made a test webpack.config.js to test it and it works.

the idea is correct, but I need to abandon, because I dont know how to work this with watch
...
gulp.task('js', function(){
	//passing our entry points -> return browserify(cfg.paths)
	//folder destination  -> .pipe(gulp.dest('.'))
	//desired name of our output file -> pipe(source('theme.min.js'))
	return browserify(cfg.paths)
	.bundle({debug:true})
